...
import { getBoards, getBoardById, addBoard, updateBoard, removeBoard, addBoardMsg, removeBoardMsg, updateGroupsSocket} from './board.controller.js'
...
router.put('/:id', requireAuth, updateGroupsSocket)
